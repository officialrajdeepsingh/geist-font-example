...
export default function Geist() {
    return (
        <div className={`${GeistSans.className} bg-white py-6 sm:py-8 lg:py-12`}>
            <div className="mx-auto max-w-screen-md px-4 md:px-8">

                <Link className='mt-4 text-left text-2xl font-light text-gray-500 sm:text-1xl' href={'/'}>Back</Link>

                <h1 className="my-8 text-center text-2xl font-bold text-gray-800 sm:text-3xl">Geist Sans Font Example</h1>
